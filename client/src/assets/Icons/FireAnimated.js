...
function FireAnimated(props) {
  return (
    <SVGIcon {...props}>
      ...
      <Path2 d="M24.13,16.52a1,1,0,0,0,1.13.93,1.07,1.07,0,0,0,.51-.11c1.63-.85,3.6-4.08,3.63-6.38a6.63,6.63,0,0,0-3.13-5.75A1,1,0,0,0,25.82,5c-.1,0-.1.09,0,.21a7.62,7.62,0,0,1,1,3.6C26.8,13.15,23.89,14.52,24.13,16.52Z" />
    </SVGIcon>
  );
}
